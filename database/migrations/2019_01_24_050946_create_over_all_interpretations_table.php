...
class CreateOverAllInterpretationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('over_all_interpretations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('over_all_interpretations');
    }
}
