...
class CreateParentCategoryWiseInterpretation extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('parent_category_wise_interpretation', function (Blueprint $table) {
           $table->increments('id');
    ...
    {
        Schema::dropIfExists('parent_category_wise_interpretation');
    }
}
