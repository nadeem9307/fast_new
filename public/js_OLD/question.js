      ...
      template: function (row) {
        ...
        else if(file_ext[1]=='mp4')
        {
            ...
            <div><video width="300" id="video">\
              <source src="./storage/app/questions/'+row.file_attached+'" type="video/mp4" autoplay>\
            </video></div>\
                        ';
        }
        ...
        {
          return '\
          <div><img src="./storage/app/questions/'+row.file_attached+'" width="300" height="300"></div>\
          ';
        }
        else
        {
...
//      var dropup = (row.getDatatable().getPageSize() - row.getIndex()) <= 4 ? 'dropup' : '';
    ...
    $('#categorylist').on('change',function(){
      var value = $(this).val();
      datatable.setDataSourceQuery({category_id:value});
      datatable.reload();
    });
