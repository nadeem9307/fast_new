...
class UserReportController extends Controller {
    ...
    public function getUserReport(Request $request, $id) {
        try {
            ...
            /*$fast_score = Helper::getUserFastScore($id);*/
            $data = UserReport::getUsersResult($request, $id,$fast_score);
                $testresult = $data['testresult'];
                $cat_result = $data['cat_result'];
                $summary = $data['summary'];
                return view('admin.users.test_report', compact('cat_result', 'user','summary'))->with(['testresult' => $testresult]);
