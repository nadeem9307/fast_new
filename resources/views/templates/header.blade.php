            ...
            <div class="m-stack__item m-brand">
                <div class="m-stack m-stack--ver m-stack--general m-stack--inline">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        ...
                        <a href="{{url('parent/overview')}}" class="m-brand__logo-wrapper">
                            @else
                                            ...
                                            <div class="m-dropdown__content">
                                                <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--brand" role="tablist">
                                                    <li class="nav-item m-tabs__item">
                                                        <button type="button" class="btn btn-primary m-btn" onclick="markNotificationRead()">
                                                            Mark as Read
                                                        </button>
                            ...
                            <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
                                <a href="#" class="m-nav__link m-dropdown__toggle">
                                    ...
                                    <span class="m-topbar__userpic test">
                                        @if(isset(Auth::user()->instructor_avatar) && Auth::user()->instructor_avatar !='')
                                        <img src="{{asset('storage/'.Auth::user()->instructor_avatar)}}" class="img-responsive user_img">
                                        @else
                                        @php
                                        $avatar_images = Helper::getUserAvtars(Auth::user());
                                        @endphp
                                        @if(isset($avatar_images['images']) && !empty($avatar_images['images']))
                                        <img src="{{asset('storage/app/levelavatar/'.$avatar_images['dir']['subdir'].'/'.$avatar_images['images'][0])}}" class="img-responsive m--img-rounded m--marginless m--img-centered" alt="my profile">
                                        @else
                                                ...
                                                <ul class="m-nav m-nav--skin-light">
                                                    <li class="m-nav__item">
                                                        <a href="{{url('profile')}}" class="m-nav__link">
                                                            ...
                                                            <i class="m-nav__link-icon flaticon-settings theme-text">
                                                            </i>
                                                        </a>
                                                    </li>
                                                    <li class="m-nav__item">
                                                        <a href="{{url('/manage_request/1')}}" class="m-nav__link">
                                                            <span class="m-nav__link-text">
                                                                My @if(Auth::user()->user_type=='2') Children @else Parents @endif
                                                            </span>
                                                            <i class="m-nav__link-icon flaticon-avatar theme-text">
                                                            </i>
                                                        </a>
                                                    </li>
                                                    <li class="m-nav__item">
                                                        <a href="{{url('/manage_request/2')}}" class="m-nav__link">
                                                            <span class="m-nav__link-text">
                                                                My Friends
                                                            </span>
                                                            <i class="m-nav__link-icon flaticon-users theme-text">
                                                            </i>
                                                        </a>
                                                    </li>
                                                    <li class="m-nav__item">
                                                        <a href="{{ route('logout') }}" class="m-nav__link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                            ...
                                                            <i class="m-nav__link-icon la la-power-off theme-text">
                                                            </i>
                                                        </a>
