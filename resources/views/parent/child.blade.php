          ...
          <div class="col-md-4">
            ...
            <div class="user_info">
              <h4>Hey {{$childrecord->name}} <br>
                @if(isset($testresult->long_summary) && $testresult->long_summary!="") <span> You are a - <strong>{{$testresult->long_summary}}</strong>
                </span> @endif
              </h4>
            ...
            <div class="control_heading">
              <div class="left_control prev_result_id">
                @if(isset($testresult->prev_id) && $testresult->prev_id!="")
                  <button class="ctrl_btn next_data" data-id="{{$testresult->prev_id}}"><i class="la la-long-arrow-left"></i><span class="theme-text">Previous Result</span></button>
                  @else
                  <button class="ctrl_btn" style="visibility: hidden;"><i class="la la-long-arrow-left"></i><span class="theme-text">Previous Result</span></button>
                @endif
              </div>
              ...
              <div class="right_control next_result_id">
                @if(isset($testresult->next_id) && $testresult->next_id!="")
                  <button class="ctrl_btn next_data" data-id="{{$testresult->next_id}}"><span class="theme-text">Next Result</span><i class="la la-long-arrow-right"></i></button>
                  @else
                  <button class="ctrl_btn" style="visibility: hidden;"><span class="theme-text">Next Result</span><i class="la la-long-arrow-right"></i></button>
                @endif
                ...
                success: function (data) {
                    ...
                    if(res.status="success")
                    {
                        if(!$.isEmptyObject(res.data.testresult))
                        {
                            ...
                            {
                                $('.next_result_id').html('<button class="ctrl_btn next_data" data-id="'+res.data.testresult.next_id+'"><span class="theme-text">Next Result</span><i class="la la la-long-arrow-right"></i></button>');
                            }
                            else
                            {
                                $('.next_result_id').html('<button style="visibility:hidden" class="ctrl_btn"><span class="theme-text">Next Result</span><i class="la la la-long-arrow-right"></i></button>');
                            }
                            if(res.data.testresult.prev_id!="")
                            {
                                $('.prev_result_id').html('<button class="ctrl_btn next_data" data-id="'+res.data.testresult.prev_id+'"><i class="la la la-long-arrow-left"></i><span class="theme-text">Previous Result</span></button>');
                            }
                            else
                            {
                                $('.prev_result_id').html('<button style="visibility:hidden" class="ctrl_btn"><span class="theme-text">Previous Result</span><i class="la la la-long-arrow-left"></i></button>');
                            }
