  ...
  <body class="dashboard m-page--wide m-header--fixed m-header--fixed-mobile m-footer--push m-aside--offcanvas-default"  >
    ...
    <script>
        ...
        <script type="text/javascript">
          $('.takefastbutton').click(function (e) {
              e.preventDefault();
                      ...
                      if (res.status == 'error') {
                          ...
                          if (!$.isEmptyObject(result))
                          {
                            $.each(result, function (key, val) {
                                    semblocks += '<div class="col-xl-6 col-sm-6" onclick="gettaketest(' + val.levelid + ',' + val.sublevel_id + ',' + val.SemID + ')"><div class="score_range_block text-center bg-success sem">'
                                            + '<div class="align-items-center"><h5 class="text-white">' + val.level_name + '</h5>'
                                            + '<div class="align-items-center"><h5 class="text-white">' + val.sublevel_name + '</h5>'
                                            + '<span class="align-items-center text-white">' + val.sem_name + '</span></div></div></div></div>';
                          ...
                          else
                          {
                            ...
                            if(test_type=='1')
                            {
                              semblocks += '<div class="col-xl-6 col-sm-6 align-items-center mr-auto"><div class="score_range_block text-center bg-success sem">'
                              + '<div class="text-white">Congratulation you complete all parts of current level. Please change your level for proceed further.</div></div></div>';
                            }
                            else
                            {
                              semblocks += '<div class="col-xl-6 col-sm-6 align-items-center mr-auto"><div class="score_range_block text-center bg-success sem">'
                              + '<div class="text-white">No Test Attempted for this Level and Sublevel.</div></div></div>';
                            }
                          }
