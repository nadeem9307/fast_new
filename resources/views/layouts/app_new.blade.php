            ...
            <footer class="m-grid__item m-footer ">
                <div class="m-container m-container--responsive m-container--xxl m-container--full-height m-page__container">
                    <div class="m-footer__wrapper row">
                        <div class="footer-section col-xl-6 col-sm-6">
                            <a href="#">
                                <img src="{{ url('public/assets/demo/demo5/media/img/logo/FastIndexLogo.png')}}" alt="" class="logo">
                            </a>
                            <p>FAST is a proprietary financial profiling system that measures an Individual’s financial aptitude and behaviour towards money. The results will give you an indication of how well informed and “equipped” you are to with money matters as well as grow your wealth.
                            </p>
                        </div>
                        ...
                        <div class="footer-section col-xl-3 d-md-none d-xl-block">
                        </div>
                        <div class="footer-section col-xl-3 col-sm-6">
                            <h4>
                                Brought to you by:
                            ...
                            <a href="#">
                                <img src="{{ url('public/assets/demo/demo5/media/img/Monytree_footer.png')}}" alt="" class="logo">
                            </a>
                        </div>
                    </div>
                </div>
