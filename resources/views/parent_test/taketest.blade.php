                                ...
                                <!-- start questio image media -->
                                 <div class="question_media">
                                    @if(isset($question->file_attached) && $question->file_attached!="")
                                        @php
                                            $extension = strtolower(pathinfo(storage_path('app/parent_questions/'.$question->file_attached), PATHINFO_EXTENSION));
                                        @endphp
                                        @if($extension=="mp4")
                                            <video id="myVedio" controls>
                                                <source src="{{asset('storage/app/parent_questions/'.$question->file_attached)}}" type="video/mp4">
                                            </video>
                                        @elseif($extension=="mp3")
                                            <audio id="myAudio" controls>
                                                <source src="{{asset('storage/app/parent_questions/'.$question->file_attached)}}" type="audio/mpeg">
                                            </audio>
                                        @else
                                            <img src="{{asset('storage/app/parent_questions/'.$question->file_attached)}}" class="img-responsive user_img">
                                        @endif
                                    @endif
                                </div>
                ...
                <div class="col-xl-8 mr-auto">
                    <div class="congrats_block">
                        <div class="text-center col-xl-12">
                            <h2>There is no question for you.</h2>
                            <div class="text-center next_prev_btn_group ">
                                <a href="{{url('parent/overview')}}">
...
<script src="{{ asset('public/js/parent_test.js') }}"></script>
