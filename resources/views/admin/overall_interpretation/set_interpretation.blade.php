    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">
                Set Child Over All Score Range
            </h3>
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="{{ url('categories')}}" class="m-nav__link">
                        <span class="m-nav__link-text">
                            Set Interpretation
                        </span>
                    </a>
           ...
           
            {
                ...
                template: function (row) {
                    return '<div class="btn-group" role="group">'+
                                '<button type="button" class="btn btn-success background_gradient btn-view dropdown-toggle" title="Manage"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'
                                    +'Manage'
                                +'</button>'
                ...
                + '<a class="dropdown-item" href="' + APP_URL + '/interpretation/{{$level->id}}/range/'+ row.id+ '">{{$level->level_name}}</a>'
                @endforeach
                               +'</div>'
                            +'</div>';
                },
