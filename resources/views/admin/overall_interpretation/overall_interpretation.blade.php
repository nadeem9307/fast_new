    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">
                Set Child Over All Interpretation
            </h3>
...
<script>
                ...
                function setInterpretation(vals) {
                    ...
                    //                        var j = 1;
                    //                        var ansHtml = '';
                    //                        $.each(interpretations, function (idx, values) {
                    //                            console.log(values);
                    ...
                    //                        var ansHtml = '';
                    //                        ansHtml += '<div data-repeater-item class="d-flex align-items-center clonedOptionsForMultiChoice m--margin-bottom-10"><div class="col-md-9"><div class="input-group"><input type="text" class="form-control options_value " aria-label="Enter Option"></div><div class="d-md-none m--margin-bottom-10"></div></div><div class="col-md-3"><div data-repeater-delete="" class="btn-sm btn btn-danger m-btn m-btn--icon m-btn--pill"><span><i class="la la-trash-o"></i><span>Delete</span></span></div></div></div>';
                    //                        $("#MultiAnswerResponse").html(ansHtml);
                    //                    }
                ...
                function getInterpretation(vals) {
                    ...
                    $.ajax({
                        method: 'POST',
                        url: APP_URL + "/get/overall/interpretation",
                        data: {
                            cat_ids: cat_ids,
                            range_ids: range_ids,
                            overall_range: overall_range,
                        ...
                        success: function (data) {
                            ...
                            if (res.status == 'error') {
                                ...
                                if (res.message.id != '') {
                                    ...
                                    /*$("#summary").val(res.message.summary);*/
                                } else {
                                    $("#MultiAnswerResponse").html('');
                                    var ansHtml = '';
